...
{
    public partial class CheckStudentAttendance : Form
    {
        OleDbConnection connection = new OleDbConnection();
        private store1 str;
        public CheckStudentAttendance()
        {
            InitializeComponent();
        }
        public CheckStudentAttendance(store1 stro)
        {
            InitializeComponent();
            str = stro;
            LPIN.Text = str.pinL;
        ...
        private void CheckStudentAttendance_Load(object sender, EventArgs e)
        {
